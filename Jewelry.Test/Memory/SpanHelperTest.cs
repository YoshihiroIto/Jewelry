...
public class SpanHelperTest
{
    ...
    public void LowerBound_Empty()
    {
        ...
        Assert.Equal(0, SpanHelper.LowerBound(a.AsSpan(), 0, (x, y) => x.CompareTo(y)));
    }
    ...
    {
        var a = new[] { 1 };
        Assert.Equal(0, SpanHelper.LowerBound(a.AsSpan(), 1, (x, y) => x.CompareTo(y)));
    }
    ...
    public void LowerBound_OneElement_NotFound()
    {
        var a = new[] { 1 };
        Assert.Equal(0, SpanHelper.LowerBound(a.AsSpan(), 0, (x, y) => x.CompareTo(y)));
        Assert.Equal(1, SpanHelper.LowerBound(a.AsSpan(), 2, (x, y) => x.CompareTo(y)));
    }
    ...
    public void LowerBound_MultipleElements()
    {
        ...
        Assert.Equal(0, SpanHelper.LowerBound(a.AsSpan(), 1, (x, y) => x.CompareTo(y)));
        Assert.Equal(1, SpanHelper.LowerBound(a.AsSpan(), 2, (x, y) => x.CompareTo(y)));
        Assert.Equal(1, SpanHelper.LowerBound(a.AsSpan(), 3, (x, y) => x.CompareTo(y)));
        Assert.Equal(2, SpanHelper.LowerBound(a.AsSpan(), 4, (x, y) => x.CompareTo(y)));
        Assert.Equal(2, SpanHelper.LowerBound(a.AsSpan(), 5, (x, y) => x.CompareTo(y)));
        Assert.Equal(3, SpanHelper.LowerBound(a.AsSpan(), 6, (x, y) => x.CompareTo(y)));
        Assert.Equal(3, SpanHelper.LowerBound(a.AsSpan(), 7, (x, y) => x.CompareTo(y)));
        Assert.Equal(4, SpanHelper.LowerBound(a.AsSpan(), 8, (x, y) => x.CompareTo(y)));
        Assert.Equal(4, SpanHelper.LowerBound(a.AsSpan(), 9, (x, y) => x.CompareTo(y)));
        Assert.Equal(5, SpanHelper.LowerBound(a.AsSpan(), 10, (x, y) => x.CompareTo(y)));
    }
    ...
    {
        var a = Array.Empty<int>();
        Assert.Equal(0, SpanHelper.UpperBound(a.AsSpan(), 0, (x, y) => x.CompareTo(y)));
    }
    ...
    {
        var a = new[] { 1 };
        Assert.Equal(1, SpanHelper.UpperBound(a.AsSpan(), 1, (x, y) => x.CompareTo(y)));
    }
    ...
    public void UpperBound_OneElement_NotFound()
    {
        var a = new[] { 1 };
        Assert.Equal(0, SpanHelper.UpperBound(a.AsSpan(), 0, (x, y) => x.CompareTo(y)));
        Assert.Equal(1, SpanHelper.UpperBound(a.AsSpan(), 2, (x, y) => x.CompareTo(y)));
    }
    ...
    public void UpperBound_MultipleElements()
    {
        ...
        Assert.Equal(1, SpanHelper.UpperBound(a.AsSpan(), 1, (x, y) => x.CompareTo(y)));
        Assert.Equal(1, SpanHelper.UpperBound(a.AsSpan(), 2, (x, y) => x.CompareTo(y)));
        Assert.Equal(2, SpanHelper.UpperBound(a.AsSpan(), 3, (x, y) => x.CompareTo(y)));
        Assert.Equal(2, SpanHelper.UpperBound(a.AsSpan(), 4, (x, y) => x.CompareTo(y)));
        Assert.Equal(3, SpanHelper.UpperBound(a.AsSpan(), 5, (x, y) => x.CompareTo(y)));
        Assert.Equal(3, SpanHelper.UpperBound(a.AsSpan(), 6, (x, y) => x.CompareTo(y)));
        Assert.Equal(4, SpanHelper.UpperBound(a.AsSpan(), 7, (x, y) => x.CompareTo(y)));
        Assert.Equal(4, SpanHelper.UpperBound(a.AsSpan(), 8, (x, y) => x.CompareTo(y)));
        Assert.Equal(5, SpanHelper.UpperBound(a.AsSpan(), 9, (x, y) => x.CompareTo(y)));
        Assert.Equal(5, SpanHelper.UpperBound(a.AsSpan(), 10, (x, y) => x.CompareTo(y)));
    }
